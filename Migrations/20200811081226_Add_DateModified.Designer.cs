...
namespace DotNetCoreWebApiHomework.Migrations
{
    ...
    [Migration("20200811081226_Add_DateModified")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DotNetCoreWebApiHomework.Models.Course", b =>
                {
            ...
            modelBuilder.Entity("DotNetCoreWebApiHomework.Models.CourseInstructor", b =>
                {
                    b.Property<int>("CourseId")
                        .HasColumnName("CourseID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DotNetCoreWebApiHomework.Models.Department", b =>
                {
                    b.Property<int>("DepartmentId")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("DepartmentID")
            ...
            modelBuilder.Entity("DotNetCoreWebApiHomework.Models.Enrollment", b =>
                {
            ...
            modelBuilder.Entity("DotNetCoreWebApiHomework.Models.OfficeAssignment", b =>
                {
                    b.Property<int>("InstructorId")
                        .HasColumnName("InstructorID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DotNetCoreWebApiHomework.Models.Person", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("ID")
            ...
            modelBuilder.Entity("DotNetCoreWebApiHomework.Models.Course", b =>
                {
                    b.HasOne("DotNetCoreWebApiHomework.Models.Department", "Department")
                        .WithMany("Course")
            ...
            modelBuilder.Entity("DotNetCoreWebApiHomework.Models.CourseInstructor", b =>
                {
                    b.HasOne("DotNetCoreWebApiHomework.Models.Course", "Course")
                    ...
                    b.HasOne("DotNetCoreWebApiHomework.Models.Person", "Instructor")
                        .WithMany("CourseInstructor")
            ...
            modelBuilder.Entity("DotNetCoreWebApiHomework.Models.Enrollment", b =>
                {
                    ...
                    b.HasOne("DotNetCoreWebApiHomework.Models.Person", "Student")
                        .WithMany("Enrollment")
            ...
            modelBuilder.Entity("DotNetCoreWebApiHomework.Models.OfficeAssignment", b =>
                {
                    b.HasOne("DotNetCoreWebApiHomework.Models.Person", "Instructor")
                        ...
                        .HasForeignKey("DotNetCoreWebApiHomework.Models.OfficeAssignment", "InstructorId")
